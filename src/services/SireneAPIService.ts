...
export const SireneAPIService = {
  BASE_URL: 'https://recherche-entreprises.api.gouv.fr/search',

  async searchEntreprises(query: string, page = 1, perPage = 10): Promise<SireneSearchResponse> {
    return withLog('SireneAPIService.searchEntreprises', async () => {
  ...
  async getEntrepriseBySiret(siret: string): Promise<SireneEntrepriseResult | null> {
